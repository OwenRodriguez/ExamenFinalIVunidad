...
public class ReservacionesPK implements Serializable {
    ...
    public String toString() {
        return "org.owenrodriguez.entities.ReservacionesPK[ idreservaciones=" + idreservaciones + ", clienteIdcliente=" + clienteIdcliente + ", sucursalIdubicacion=" + sucursalIdubicacion + " ]";
    }
