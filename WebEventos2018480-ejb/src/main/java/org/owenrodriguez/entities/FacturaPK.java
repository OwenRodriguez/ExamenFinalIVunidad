...
public class FacturaPK implements Serializable {
    ...
    public String toString() {
        return "org.owenrodriguez.entities.FacturaPK[ idfactura=" + idfactura + ", reservacionesIdreservaciones=" + reservacionesIdreservaciones + ", reservacionesClienteIdcliente=" + reservacionesClienteIdcliente + ", reservacionesSucursalIdubicacion=" + reservacionesSucursalIdubicacion + " ]";
    }
