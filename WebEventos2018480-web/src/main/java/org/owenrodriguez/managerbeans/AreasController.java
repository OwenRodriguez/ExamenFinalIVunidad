...
import org.owenrodriguez.sessionsbeans.AreasFacadeLocal;
...
public class AreasController implements Serializable {
    ...
    protected void initializeEmbeddableKey() {
        selected.setAreasPK(new org.owenrodriguez.entities.AreasPK());
    }
    ...
    public Areas getAreas(org.owenrodriguez.entities.AreasPK id) {
    ...
    public static class AreasControllerConverter implements Converter {
        ...
        org.owenrodriguez.entities.AreasPK getKey(String value) {
            org.owenrodriguez.entities.AreasPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new org.owenrodriguez.entities.AreasPK();
            key.setIdareas(Integer.parseInt(values[0]));
            key.setSucursalIdubicacion(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(org.owenrodriguez.entities.AreasPK value) {
