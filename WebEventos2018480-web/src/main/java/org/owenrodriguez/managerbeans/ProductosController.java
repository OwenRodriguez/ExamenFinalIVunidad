...
import org.owenrodriguez.sessionsbeans.ProductosFacadeLocal;
...
public class ProductosController implements Serializable {
    ...
    protected void initializeEmbeddableKey() {
        selected.setProductosPK(new org.owenrodriguez.entities.ProductosPK());
    }
    ...
    public Productos getProductos(org.owenrodriguez.entities.ProductosPK id) {
    ...
    public static class ProductosControllerConverter implements Converter {
        ...
        org.owenrodriguez.entities.ProductosPK getKey(String value) {
            org.owenrodriguez.entities.ProductosPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new org.owenrodriguez.entities.ProductosPK();
            key.setIdmenu(Integer.parseInt(values[0]));
            key.setFacturaIdfactura(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(org.owenrodriguez.entities.ProductosPK value) {
