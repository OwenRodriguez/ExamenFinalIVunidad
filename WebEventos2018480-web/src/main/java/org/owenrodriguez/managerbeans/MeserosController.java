...
import org.owenrodriguez.sessionsbeans.MeserosFacadeLocal;
...
public class MeserosController implements Serializable {
    ...
    protected void initializeEmbeddableKey() {
        selected.setMeserosPK(new org.owenrodriguez.entities.MeserosPK());
    }
    ...
    public Meseros getMeseros(org.owenrodriguez.entities.MeserosPK id) {
    ...
    public static class MeserosControllerConverter implements Converter {
        ...
        org.owenrodriguez.entities.MeserosPK getKey(String value) {
            org.owenrodriguez.entities.MeserosPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new org.owenrodriguez.entities.MeserosPK();
            key.setIdmeseros(Integer.parseInt(values[0]));
            key.setSucursalIdubicacion(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(org.owenrodriguez.entities.MeserosPK value) {
