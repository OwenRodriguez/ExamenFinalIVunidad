...
import org.owenrodriguez.sessionsbeans.DetalleFacadeLocal;
...
public class DetalleController implements Serializable {
    ...
    protected void initializeEmbeddableKey() {
        selected.setDetallePK(new org.owenrodriguez.entities.DetallePK());
    }
    ...
    public Detalle getDetalle(org.owenrodriguez.entities.DetallePK id) {
    ...
    public static class DetalleControllerConverter implements Converter {
        ...
        org.owenrodriguez.entities.DetallePK getKey(String value) {
            org.owenrodriguez.entities.DetallePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new org.owenrodriguez.entities.DetallePK();
        ...
        String getStringKey(org.owenrodriguez.entities.DetallePK value) {
